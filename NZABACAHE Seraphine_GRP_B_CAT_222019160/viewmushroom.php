...
<body>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold; color:blue;">THIS TABLE SHOWS ALL TYPE OF MUSHROOM </h4>
        <a href="mushroom.html" class="btn btn-primary" style="margin-top: 0px;">New mushroom</a>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>{$row['mushroom_name']}</td> 
                        <td>{$row['description']}</td>
                        <td>{$row['quantity']}</td>
                        <td>{$row['unit_price']}</td>
                        <td>{$row['total_price']}</td>
                        <td>
                            <a href='editmushrooms.php?mushroom_id={$row['mushroom_id']} class='btn btn-primary btn-sm'>Edit</a></td>
                            <td>
                            <a href='deleteharvest.php?mushroom_id={$row['mushroom_id']} class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
